...
class APIConfig:
    ...
    LLM_COMMAND_R_HOST: str = os.getenv("LLM_COMMAND_R_HOST", "149.222.209.100")
    ...
    def print_config(cls) -> None:
        ...
        print(f"SD URL: {cls.SD_URL}")
        print(f"Whisper URL: {cls.WHISPER_URL}")
